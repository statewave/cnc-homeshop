...
module ThickCutPlan() {
  translate([43,202]) Layer0();
  translate([55,262]) Layer0_Hose();
  translate([116,122]) rotate([0,0,-90-45]) Layer2();
  translate([43,43]) rotate([0,0,180]) rotate([0,0,-90-45]) Layer2();
}

module ThinCutPlan() {
  translate([114,114]) rotate([0,0,34-180]) Layer1();
  translate([114-71,114-71]) rotate([0,0,34]) LayerN();
}
